...
,
					"patching_rect" : [ 384.0, 245.0, 77.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "list", "" ],
					"patching_rect" : [ -288.0, 494.0, 107.0, 22.0 ],
					"text" : "30_OSC_Volumes"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ -190.5, 562.0, -51.5, 562.0 ],
					"source" : [ "obj-40", 1 ]
				}
