...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 267.5, 12.0, 89.5, 50.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 185.25, 6.0, 59.5, 62.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 870.0, 140.0, 257.0, 136.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 13.0, 27.0, 97.5, 62.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 380.0, 30.0, 138.0, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 559.75, 33.0, 131.0, 50.0 ],
					"text" : "if the window is opened, close it; and vice versa",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 580.0, 84.0, 73.0, 21.0 ],
					"text" : "/openorclose"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 275.0, 58.0, 94.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 193.0, 64.0, 44.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "val1", "val2" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 193.0, 83.0, 59.0, 21.0 ],
					"text" : "/visible $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 126.0, 33.0, 59.5, 50.0 ],
					"text" : "or use ctrl+w",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 137.0, 83.0, 40.0, 21.0 ],
					"text" : "/close"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 275.0, 83.0, 46.0, 21.0 ],
					"text" : "/title $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 36.0, 83.0, 39.0, 21.0 ],
					"text" : "/open"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 202.5, 117.0, 22.5, 117.0 ],
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-28", 0 ],
					"midpoints" : [ 45.5, 117.5, 22.5, 117.5 ],
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-28", 0 ],
					"midpoints" : [ 284.5, 117.5, 22.5, 117.5 ],
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-28", 0 ],
					"midpoints" : [ 146.5, 117.5, 22.5, 117.5 ],
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-28", 0 ],
					"midpoints" : [ 589.5, 119.5, 22.5, 119.5 ],
					"source" : [ "obj-69", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-10" : [ "live.menu[2]", "live.toggle", 0 ],
			"obj-102" : [ "live.toggle[2]", "live.toggle", 0 ],
			"obj-11" : [ "live.toggle[11]", "live.toggle", 0 ],
			"obj-131" : [ "live.toggle[3]", "live.toggle", 0 ],
			"obj-139" : [ "live.toggle[4]", "live.toggle", 0 ],
			"obj-14" : [ "live.dial[2]", "scale", 0 ],
			"obj-2" : [ "live.toggle[14]", "live.toggle", 0 ],
			"obj-22" : [ "live.toggle[5]", "live.toggle", 0 ],
			"obj-26" : [ "live.toggle[46]", "live.toggle", 0 ],
			"obj-29" : [ "live.toggle[8]", "live.toggle", 0 ],
			"obj-36::obj-62" : [ "live.text[12]", "live.text[9]", 0 ],
			"obj-52" : [ "live.toggle[43]", "live.toggle", 0 ],
			"obj-54" : [ "live.toggle[10]", "live.toggle", 0 ],
			"obj-56" : [ "live.toggle[44]", "live.toggle", 0 ],
			"obj-58" : [ "live.toggle[45]", "live.toggle", 0 ],
			"obj-67" : [ "live.toggle[7]", "live.toggle", 0 ],
			"obj-81" : [ "live.toggle[9]", "live.toggle", 0 ],
			"obj-82" : [ "live.toggle[12]", "live.toggle", 0 ],
			"obj-83" : [ "live.toggle[13]", "live.toggle", 0 ],
			"obj-85" : [ "live.toggle[15]", "live.toggle", 0 ],
			"parameterbanks" : 			{
