...
,
		"classnamespace" : "box",
		"rect" : [ 76.0, -1121.0, 1523.0, 1059.0 ],
		"bglocked" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 984.0, 674.0, 118.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1105.5, 471.0, 65.0, 22.0 ],
					"text" : "pak 0 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 16.0, -136.0, 50.0, 89.0 ],
					"text" : "0.016859 0.254392 -0.329855"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 560.75, -30.0, 97.0, 22.0 ],
					"text" : "unpack 0 0. 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 560.75, -69.0, 71.0, 22.0 ],
					"text" : "route /synth"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 105.0, -208.0, 52.0, 22.0 ],
					"text" : "route 11"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 20.0, -208.0, 53.0, 22.0 ],
					"text" : "route 17"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 40.0, -342.0, 103.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 198.5, -265.0, 123.0, 35.0 ],
					"text" : "/voice/evaluation/low 6 49 5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 37.5, -258.0, 71.0, 22.0 ],
					"text" : "route /synth"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 801.0, 295.0, 764.0, 22.0 ],
